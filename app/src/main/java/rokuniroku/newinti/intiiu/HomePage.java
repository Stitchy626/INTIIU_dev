...
public class HomePage extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.get().load(mUser.getPhotoUrl()).into(imagView_UserPic);
        ...
        //Update Checking in remote config
        ...
        imgViewAcademicCalendar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Academic_calendar.class);
